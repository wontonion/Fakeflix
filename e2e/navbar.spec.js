...
test.describe("Navbar Tests", () => {
    ...
    test.describe("Navbar logo", () => {
      ...
      test.describe("Search Functionality", () => {
        ...
        // test('should show search result after typing in search bar', async () => {
        // });
      });
      ...
      test.describe("Active link highlighting", () => {
        test("should add activeNavLink class to clicked navbar links", async () => {
          ...
          await expect(page.locator('a[href="/browse"]')).toHaveClass("activeNavLink");
          ...
          await expect(page.locator('a[href="/tvseries"]')).toHaveClass("activeNavLink");
          ...
          await expect(page.locator('a[href="/movies"]')).toHaveClass("activeNavLink");
          
          // Click on New & Popular link and verify it gets activeNavLink class
          await page.locator('a[href="/popular"]:has-text("New & Popular")').click();
          await page.waitForURL("/popular");
          await expect(page.locator('a[href="/popular"]')).toHaveClass("activeNavLink");
          ...
          await expect(page.locator('a[href="/mylist"]')).toHaveClass("activeNavLink");
